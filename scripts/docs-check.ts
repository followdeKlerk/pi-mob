...
const TARGETS = ["README.md", "CONTRIBUTING.md", "SECURITY.md", "CHANGELOG.md", "docs", "apps/mobile/README.md", "packages/bridge/README.md", "packages/protocol-schema/README.md"];
