...
requireText("docs/PROJECT_STATUS.md", "| without-FCM | `commands.v1`, `controller_leases.v1`, `session_events.v2`, `streams.v1` |");
requireText("docs/PROJECT_STATUS.md", "| with-FCM | `commands.v1`, `controller_leases.v1`, `notifications.v1`, `session_events.v2`, `streams.v1` |");
