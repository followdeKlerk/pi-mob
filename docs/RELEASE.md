...
2. Set the canonical preview version in `VERSION`; for this release it is `0.0.2-alpha.1` with Android version code `2`. The bridge and APK read the same repository version source.
...
## Notes for the `v0.0.2-alpha.1` preview
