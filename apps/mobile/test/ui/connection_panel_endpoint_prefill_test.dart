...
void main() {
  ...
  testWidgets(
    ...
    fixture.coordinator.debugSetEndpoint(Uri.parse('https://pi.tailnet.ts.net'));
  ...
  testWidgets(
    ...
    expect(
      ConnectionCoordinator.sanitizedEndpointLabel(Uri.parse('http://10.0.0.5:8788')),
      '10.0.0.5:8788',
    );
  ...
  testWidgets(
    ...
    final widget = tester.widget<SelectableText>(find.byKey(const Key('connection-error')));
