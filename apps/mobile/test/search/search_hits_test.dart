...
void main() {
  ...
  test('typed file and git destinations remain opaque and exact', () {
    final file = SearchHit(
      hostId: 'host',
      sessionId: 'session',
      sessionName: 'Chat',
      eventId: 'file',
      ...
      destination: const <String, Object?>{
        'kind': 'file',
    ...
    expect(file.destination['path'], 'lib/main.dart');
    expect(searchSourceWire(SearchSource.git), 'git');
    expect(searchSourceWire(SearchSource.workspace), 'workspace');
  });
}
